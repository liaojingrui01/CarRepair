	...
	<div class="logDiv">
		...
		<div class="logGet">
			...
			<div class="logD logDtip">
				<p class="p1">登录</p>
				<p class="p2">最强汽修人员登录</p>
			</div>
			<!-- 输入框 -->
			<form action="${pageContext.request.contextPath}/admUrl?op=login" method="post" >
				<div class="lgD">
					<img class="img1" src="/CarWebPro/backstage/img/logName.png" />
					<input type="text" name="adm_name"  placeholder="输入用户名" />
				</div>
				<div class="lgD">
					<img class="img1" src="/CarWebPro/backstage/img/logPwd.png" />
					<input type="password" name="adm_pwd"  placeholder="输入用户密码" />
				</div>
				<div class="logC">
